...
public class RestaurantListAdapter extends ArrayAdapter<Restaurant> {
    ...
    public RestaurantListAdapter(Context context, List<Restaurant> restaurants, LatLng latLng, List<Restaurant> favoriteRestaurants) {
    ...
    public void setFavoriteRestaurantToDatabase(Restaurant restaurant) {
        ...
        DocumentReference collRef =
                db.collection("users").
                        ...
                        collection("Favorite").
                        document();
        collRef.set(restaurant).
                addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        String id = collRef.getId();
    ...
    private boolean isRestaurantFavorite(Restaurant restaurant) {
        for (Restaurant favRestaurant : favoriteRestaurants) {
            if (restaurant.equals(favRestaurant)) {
                restaurant.setFavorite(favRestaurant.isFavorite());
                restaurant.setRestaurantID(favRestaurant.getRestaurantID());
                return favRestaurant.isFavorite();
            }
        }
        return false;
    }
